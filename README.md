...
- [ ] Ingredients screen:
    ...
    - [ ] Change view
- [x] Add calculator:
  - [x] ~~Replace mocked calculations with real one~~
  - [x] ~~Change must parameters display screen to "confirm must parameters and desired wine and apply calculations" screen~~
- [ ] Add auxiliary alcohol measurement/calculation screen
